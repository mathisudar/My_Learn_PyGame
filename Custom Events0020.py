...
while running:
    ...
    for event in pygame.event.get():
        ...
        if event.type == ON_BOX:
            ...
            if grow:
                box.inflate_ip(3, 3) # grow or shrink the rectangle size, in place
                grow = box.width < 75
            else:
                box.inflate_ip(-3, -3)
                grow = box.width < 50
    ...
    # of the box
    if box.collidepoint(pygame.mouse.get_pos()): # Returns true if the given point is inside the rectangle. 
